<template>
  <div class="flex flex-col w-full bg-white rounded shadow-lg max-w-md">
    <div class="w-full h-60 bg-top bg-cover rounded-t" :style="`background-image: url(${image})`"></div>
