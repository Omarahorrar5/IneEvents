    ...
    <div class="max-w-6xl mx-auto">
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        ...
        <div class="lg:col-span-2">
          ...
          <div class="flex space-x-4">
            <a href="#" class="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-primary/20 transition-colors">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10">
        <p class="text-textMuted text-sm mb-4 md:mb-0">
          © 2024 IneEvents. All rights reserved.
        </p>
